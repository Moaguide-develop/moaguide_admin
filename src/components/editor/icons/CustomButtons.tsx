...
import AddPhoto from '../handler/AddPhoto'; // AddPhoto 컴포넌트 가져오기
...
const CustomIcon = {
  Quote: ({ editor }: { editor: Editor }) => (
    <button
      ...
      className={`p-2 rounded ${isActive(editor, 'blockquote')}`}
    >
      <svg
  ...
  AddPaywall: ({ editor }: { editor: Editor }) => <AddPaywall editor={editor} />,
};
